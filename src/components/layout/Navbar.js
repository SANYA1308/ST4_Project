...
const Navbar = () => {
  return (
    <nav className="navbar navbar-expand-lg navbar-dark fixed-top" style={{backgroundColor:"red",position:"sticky"}}>
      <div className="container">
        <Link exact to="/">
          <img src={mw} width="60px" height="60px" style={{borderRadius:"50%",margin:"0% 5px -8px -35px"}} />
        </Link>
        <h3 style={{color:"white",margin:"0px 55% 0px 5px"}}>TechSocial</h3>
        <button
